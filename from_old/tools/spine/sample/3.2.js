...
clone_node.get('model').setPosition(200,220);
Smgr.add(clone_node);

clone_node.get('model').setFrame(1);
clone_node.findByName("body").get('model').setFrame(2);

Smgr.updateAll();

setInterval(function() {
    node.get('model').nextFrame();
    //node.update();
},300);

setInterval(function() {
    clone_node.findByName("body")
        .get('model')
        .nextFrame();
