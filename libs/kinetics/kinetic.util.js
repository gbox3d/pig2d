...
gbox3d.Kinetic.Util.Cutter = function (layer) {
    ...
    this.getRect = function(offset) {
        ...
        var rgninfo = RectShape.rgnInfo; //특권함수 장점을 살려 그냥 내부 변수 바로 접근하지
        //var rgninfo = cutter_group.get(".rgn")[0].rgnInfo;
        ...
        //var strTemp = start.X + "," + start.Y + "," + (end.X - start.X) + "," + (end.Y - start.Y);
